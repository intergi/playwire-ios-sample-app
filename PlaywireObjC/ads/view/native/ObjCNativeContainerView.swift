...
@MainActor
@objc(ObjCNativeContainerViewDelegate)
public protocol ObjCNativeContainerViewDelegate: AnyObject {
    @objc optional func nativeContainerViewDidStartLoading(_ containerView: ObjCNativeContainerView, adUnitName: String)
    @objc optional func nativeContainerViewDidLoad(_ containerView: ObjCNativeContainerView, adUnitName: String)
    @objc optional func nativeContainerViewDidFailToLoad(_ containerView: ObjCNativeContainerView, adUnitName: String)
    @objc optional func nativeContainerViewDidRecordImpression(_ containerView: ObjCNativeContainerView, adUnitName: String)
    @objc optional func nativeContainerViewDidRecordClick(_ containerView: ObjCNativeContainerView, adUnitName: String)
}

// MARK: - Container View

@MainActor
@objc(ObjCNativeContainerView)
@objcMembers
public final class ObjCNativeContainerView: UIView {

    public weak var delegate: ObjCNativeContainerViewDelegate?

    private let adUnitName: String
    private weak var controller: UIViewController?

    private lazy var impl: ObjCNativeContainerViewImpl = {
        ObjCNativeContainerViewImpl(
